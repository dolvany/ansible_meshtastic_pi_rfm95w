Ansible playbook for raspberry pi with the adafruit rfm95w hat. Based on the official [linux native instructions](https://meshtastic.org/docs/hardware/devices/linux-native-hardware/?os=debian).
# The Build
